...
<template>
  <div class="flex flex-col">
    ...
    <div class="h-44 overflow-hidden sm:h-64  md:h-72">
    ...
    >
      <img
        class="w-3/12 sm:w-2/12 rounded-3xl absolute bottom-3/4 shadow-lg drop-shadow-md "
    ...
    <div class="flex bg-red-600 rounded-full px-3 mx-4 h-9 sm:mx-56 sm:justify-center sm:rounded-xl mt-3 justify-end">
    ...
    <div class="flex bg-blue-600 rounded-full px-3 mx-4 h-9 justify-end mt-3 sm:mx-56 sm:justify-center sm:rounded-xl">
    ...
    <p class="px-7 mt-4 text-xs text-black font-medium leading-4 sm:text-lg sm:px-16 sm:text-center">
