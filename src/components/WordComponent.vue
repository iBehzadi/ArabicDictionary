<template>
  <!-- کامپوننت لغات   -->
  <div class="w-full h-auto shadow-sm border flex bg-gray-50 mb-1 rounded-xl">
    <div class="flex-grow text-sm pt-1 pr-2">
      ...
      <div class="text-gray-600 pb-1">{{ obj?.translate }}</div>
      <div class="text-gray-400 pb-1">{{ obj?.sample }}</div>
    </div>
