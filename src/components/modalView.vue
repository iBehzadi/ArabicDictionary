...
<template>
    <transition name="modal-fade">
        <div class="bg-modal flex-center fixed top-0 bottom-0 right-0 left-0 bg-black bg-opacity-30" @click="closeModal">
            <div class="modal text-xs overflow-auto flex flex-col w-9/12 md:text-base lg:text-lg lg:w-8/12 lg:h-auto rounded-15 font-sans bg-white shadow-2md" role="dialog">
                <header class="mt-4 mx-2 py-1 px-2">
                    <slot name="body1"></slot>
                </header>
                <section class="py-1 px-2 mx-2">
